    ...
    <>
      <div className='container'>
       <h2 className={`text-${props.mode==='light'?'dark':'white'}`}>{props.heading} </h2>
          <div className="mb-3">
             <textarea className="form-control" style={{backgroundColor:props.mode==='light'?'white':'gray', color:props.mode==='light'?'dark':'white'}} value={text} onChange={handeleOnChange} id="myBox" rows="8" ></textarea>
          </div>
